...
export const foodstore = writable([
    ...
    { item_id: 5, item_img: "../img/img5.png", item_name : "McVeggie Burger", description : "A vegetarian burger from McDonalds, which served with lettuce, cheese, and mayonnaise.", quantity : 1 ,price : 239},
    { item_id: 6, item_img: "../img/img6.jpeg", item_name : "McAloo Tikki Burger", description : "A vegetarian burger from McDonalds, which served with lettuce, cheese and mayonnaise.", quantity : 1 ,price : 179},
